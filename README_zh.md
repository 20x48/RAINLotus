...
* 🔄无限嵌套~~（禁 止 套 娃）~~
* 🎨丰富的内联标记
    * （最基本的）**粗体**、*斜体*、***粗斜体***、~~删除线~~、<sup>上标</sup>、<sub>下标</sub>、减淡、标记（后两项无法在GFM当中体现）
    * 自带刮刮条！
    * 还有屏蔽条（“████”这种）
...
文档地址：<https://docs.20x48.net/zh/RAINLotus/README>

发行公告：<https://docs.20x48.net/zh/RAINLotus/release-note>
